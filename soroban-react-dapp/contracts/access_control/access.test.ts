...
describe('Access Contract deployment test', function () {
    const addressBook = AddressBook.loadFromFile(network, loadFromFile);
    const currentContractHash = addressBook.getContractId("access");//
    const wasmHash = addressBook.getWasmHash("access");
